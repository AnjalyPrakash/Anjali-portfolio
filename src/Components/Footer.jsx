        ...
        <div>
            <div className='bg-dark text-light fixed-bottom'>
                <div className='container d-flex'>
                    <p className='fw-bold pt-3'>Copyright © 2024 <Link to={'/'} className='text-decoration-none'><span className='text-warning'>ANJALY PRAKASH</span></Link> | Portfolio. All Rights Reserved</p>
