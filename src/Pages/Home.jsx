            ...
            <div className='container mb-5 mt-5 '>
                <Row className='d-flex justify-content-center align-items-center w-100 mb-5 mt-5'>
                    ...
                    <Col md={6} className='ms-3 mt-5'>
                        ...
                        <p className='ms-5 mt-4'>I am a BCA graduate from SS College, Poothotta, with specialized MERN stack training from Luminar Technolab. Proficient in HTML, CSS, Bootstrap, JavaScript, React, Node, Express, and MongoDB, I led the development of an Event Management system, showcasing my ability to create robust, user-friendly applications. Currently, I am expanding my skills through a WordPress Internship at PotterWheel Media.
                        ...
                        <a href='https://drive.google.com/file/d/1p5TK1DM5DH1zC0Bkzjm4h5wzdXWtToz8/view?usp=sharing' className='text-decoration-none' target='_blank'><button className=' d-flex justify-content-center align-items-center btn ms-5 btn-outline-warning mb-5'>Download CV</button></a>
                    </Col>
